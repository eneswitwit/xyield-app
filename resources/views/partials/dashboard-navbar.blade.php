<div class="my-8">
    <nav id="nav" class="w-56 relative">
        <ul class="relative">
            <li class="@if(Request::is('dashboard') || Request::is('home')){{ 'activeLink'}}@endif">
            ...
            <li class="@if(Request::is('listings')){{ 'activeLink'}}@endif">
                <a href="{{ route('listings') }}" class="py-3 pl-1 w-full flex items-center focus:outline-none focus-visible:underline">
                        <span class="ml-3 text-sm font-medium transition-all ease-out transition-medium text-gray-700">
                        Investment Akquise
                    </span>
                </a>
            ...
            <li>
                <a href="" class="py-3 pl-1 w-full flex items-center focus:outline-none focus-visible:underline">
                    <span class="ml-3 text-sm font-medium transition-all ease-out transition-medium text-gray-700">
                        Gespeicherte Investements
                    </span>
                </a>
            </li>
            <li>
                <a href="" class="py-3 pl-1 w-full flex items-center focus:outline-none focus-visible:underline">
                    <span class="ml-2 text-sm font-medium transition-all ease-out transition-medium text-gray-500">
                        Portfolio (In Entwicklung)
                    </span>
                </a>
            </li>
            <li>
